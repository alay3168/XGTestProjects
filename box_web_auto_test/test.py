...
def send_mail():
    ...
    receivers = ['xushaohua@puppyrobot.com']
...
<script type="text/javascript">
    ...
    "testResult": [
        {
            "className": "TestLoginPage",
            "methodName": "test_LoginPage_Normal_00001",
            "description": "登陆-输入正确用户名密码能正常登录",
            "spendTime": "9.09 s",
            "status": "成功",
            "log": [
                ""
        ...
        {
            "className": "TestLoginPage",
            "methodName": "test_LoginPage_Normal_00002",
            "description": "登陆-输入错误的密码登录失败并提示：用户名或密码错误",
            "spendTime": "9.72 s",
            "status": "失败",
            "log": [
                "",
                ...
                "  File \"D:\\Program Files\\Python37\\lib\\unittest\\case.py\", line 628, in run\n    testMethod()\n",
                "  File \"D:\\Program Files\\Python37\\lib\\site-packages\\ddt.py\", line 151, in wrapper\n    return func(self, *args, **kwargs)\n",
                "  File \"E:\\PycharmProjects\\box_web_auto_test\\TestCase\\test_login_page.py\", line 60, in test_LoginPage_Normal\n    self.assertEqual(text,test_data.get('expected_re'),msg = test_data.get('msg'))\n",
                "  File \"D:\\Program Files\\Python37\\lib\\unittest\\case.py\", line 852, in assertEqual\n    assertion_func(first, second, msg=msg)\n",
                "  File \"D:\\Program Files\\Python37\\lib\\unittest\\case.py\", line 1233, in assertMultiLineEqual\n    self.fail(self._formatMessage(msg, standardMsg))\n",
                "  File \"D:\\Program Files\\Python37\\lib\\unittest\\case.py\", line 693, in fail\n    raise self.failureException(msg)\n",
                "AssertionError: '用户名或密码错误' != '今日抓拍总计：10000张'\n- 用户名或密码错误\n+ 今日抓拍总计：10000张\n : 输入错误密码登录，断言失败\n"
            ]
        }
    ],
    "testName": "抓拍盒UI测试",
