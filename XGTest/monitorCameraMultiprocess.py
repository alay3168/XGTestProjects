...
def Rtsp_DataToInfluxDB(Host,fps):
    data_list = [{
        'measurement': 'rtsp',
        'tags': {'deviceIP': Host},
        'fields': {
...
def run(Host):
    ...
    while True :
        try:
            ...
            client.write_points(Rtsp_DataToInfluxDB(host,rtsp))
            time.sleep(60)
            # num +=1
...
if __name__=='__main__':
    ...
    cameraIPList = readIPCFile(cameraIpFile)
