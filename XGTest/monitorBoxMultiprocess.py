...
def DataCenter_DataToInfluxDB(Host, cur_num2, max_num2, max_cur_num2, pkg_mem_size2, cur_num3, max_num3, max_cur_num3,
                              pkg_mem_size3):
    data_list = [{
...
def Rtsp_server_fifo_addr_DataToInfluxDB(Host, rtsp_server_0_fifo_addr, rtsp_server_1_fifo_addr,
...
def Rtsp_server_cur_num_DataToInfluxDB(Host, rtsp_server_0_cur_num, rtsp_server_1_cur_num, rtsp_server_2_cur_num,
...
#     }]
#     return data_list
def Rtsp_server_max_cur_num_DataToInfluxDB(Host, rtsp_server_0_max_cur_num, rtsp_server_1_max_cur_num,
...
def Rtsp_server_drop_num_DataToInfluxDB(Host, rtsp_server_0_drop_num, rtsp_server_1_drop_num, rtsp_server_2_drop_num,
...
def Rtsp_client_fifo_addr_DataToInfluxDB(Host, rtsp_client_0_fifo_addr, rtsp_client_1_fifo_addr,
...
def Rtsp_client_cur_num_DataToInfluxDB(Host, rtsp_client_0_cur_num, rtsp_client_1_cur_num, rtsp_client_2_cur_num,
...
def Rtsp_client_max_cur_num_DataToInfluxDB(Host, rtsp_client_0_max_cur_num, rtsp_client_1_max_cur_num,
...
def Rtsp_client_drop_num_DataToInfluxDB(Host, rtsp_client_0_drop_num, rtsp_client_1_drop_num, rtsp_client_2_drop_num,
...
def run(host):
    ...
    while num<= maxNum:
        try:
            ...
            rtsp_server_1_fifo_addr, rtsp_server_1_cur_num, rtsp_server_1_max_cur_num, rtsp_server_1_drop_num = collectDataCenter_Rtsp_server_1(
                DataCenter_Rtsp_server1)

            DataCenter_Rtsp_server2 = do_telnet(host, username, password, finish, DataCenter_RtspServer2Command)
            rtsp_server_2_fifo_addr, rtsp_server_2_cur_num, rtsp_server_2_max_cur_num, rtsp_server_2_drop_num = collectDataCenter_Rtsp_server_2(
                DataCenter_Rtsp_server2)

            DataCenter_Rtsp_server3 = do_telnet(host, username, password, finish, DataCenter_RtspServer3Command)
            rtsp_server_3_fifo_addr, rtsp_server_3_cur_num, rtsp_server_3_max_cur_num, rtsp_server_3_drop_num = collectDataCenter_Rtsp_server_3(
                DataCenter_Rtsp_server3)

            DataCenter_Rtsp_server4 = do_telnet(host, username, password, finish, DataCenter_RtspServer4Command)
            rtsp_server_4_fifo_addr, rtsp_server_4_cur_num, rtsp_server_4_max_cur_num, rtsp_server_4_drop_num = collectDataCenter_Rtsp_server_4(
                DataCenter_Rtsp_server4)

            DataCenter_Rtsp_server5 = do_telnet(host, username, password, finish, DataCenter_RtspServer5Command)
            rtsp_server_5_fifo_addr, rtsp_server_5_cur_num, rtsp_server_5_max_cur_num, rtsp_server_5_drop_num = collectDataCenter_Rtsp_server_5(
                DataCenter_Rtsp_server5)

            DataCenter_Rtsp_server6 = do_telnet(host, username, password, finish, DataCenter_RtspServer6Command)
            rtsp_server_6_fifo_addr, rtsp_server_6_cur_num, rtsp_server_6_max_cur_num, rtsp_server_6_drop_num = collectDataCenter_Rtsp_server_6(
                DataCenter_Rtsp_server6)

            DataCenter_Rtsp_server7 = do_telnet(host, username, password, finish, DataCenter_RtspServer7Command)
            rtsp_server_7_fifo_addr, rtsp_server_7_cur_num, rtsp_server_7_max_cur_num, rtsp_server_7_drop_num = collectDataCenter_Rtsp_server_7(
                DataCenter_Rtsp_server7)

            DataCenter_Rtsp_server8 = do_telnet(host, username, password, finish, DataCenter_RtspServer8Command)
            rtsp_server_8_fifo_addr, rtsp_server_8_cur_num, rtsp_server_8_max_cur_num, rtsp_server_8_drop_num = collectDataCenter_Rtsp_server_8(
                DataCenter_Rtsp_server8)

            DataCenter_Rtsp_server9 = do_telnet(host, username, password, finish, DataCenter_RtspServer9Command)
            rtsp_server_9_fifo_addr, rtsp_server_9_cur_num, rtsp_server_9_max_cur_num, rtsp_server_9_drop_num = collectDataCenter_Rtsp_server_9(
                DataCenter_Rtsp_server9)

            DataCenter_Rtsp_server10 = do_telnet(host, username, password, finish, DataCenter_RtspServer10Command)
            rtsp_server_10_fifo_addr, rtsp_server_10_cur_num, rtsp_server_10_max_cur_num, rtsp_server_10_drop_num = collectDataCenter_Rtsp_server_10(
                DataCenter_Rtsp_server10)

            DataCenter_Rtsp_server11 = do_telnet(host, username, password, finish, DataCenter_RtspServer11Command)
            rtsp_server_11_fifo_addr, rtsp_server_11_cur_num, rtsp_server_11_max_cur_num, rtsp_server_11_drop_num = collectDataCenter_Rtsp_server_11(
                DataCenter_Rtsp_server11)

            DataCenter_Rtsp_server12 = do_telnet(host, username, password, finish, DataCenter_RtspServer12Command)
            rtsp_server_12_fifo_addr, rtsp_server_12_cur_num, rtsp_server_12_max_cur_num, rtsp_server_12_drop_num = collectDataCenter_Rtsp_server_12(
                DataCenter_Rtsp_server12)

            DataCenter_Rtsp_server13 = do_telnet(host, username, password, finish, DataCenter_RtspServer13Command)
            rtsp_server_13_fifo_addr, rtsp_server_13_cur_num, rtsp_server_13_max_cur_num, rtsp_server_13_drop_num = collectDataCenter_Rtsp_server_13(
                DataCenter_Rtsp_server13)

            DataCenter_Rtsp_server14 = do_telnet(host, username, password, finish, DataCenter_RtspServer14Command)
            rtsp_server_14_fifo_addr, rtsp_server_14_cur_num, rtsp_server_14_max_cur_num, rtsp_server_14_drop_num = collectDataCenter_Rtsp_server_14(
                DataCenter_Rtsp_server14)

            DataCenter_Rtsp_server15 = do_telnet(host, username, password, finish, DataCenter_RtspServer15Command)
            rtsp_server_15_fifo_addr, rtsp_server_15_cur_num, rtsp_server_15_max_cur_num, rtsp_server_15_drop_num = collectDataCenter_Rtsp_server_15(
                DataCenter_Rtsp_server15)

            DataCenter_Rtsp_client0 = do_telnet(host, username, password, finish, DataCenter_RtspClient0Command)
            rtsp_client_0_fifo_addr, rtsp_client_0_cur_num, rtsp_client_0_max_cur_num, rtsp_client_0_drop_num = collectDataCenter_Rtsp_client_0(
                DataCenter_Rtsp_client0)

            DataCenter_Rtsp_client1 = do_telnet(host, username, password, finish, DataCenter_RtspClient1Command)
            rtsp_client_1_fifo_addr, rtsp_client_1_cur_num, rtsp_client_1_max_cur_num, rtsp_client_1_drop_num = collectDataCenter_Rtsp_client_1(
                DataCenter_Rtsp_client1)

            DataCenter_Rtsp_client2 = do_telnet(host, username, password, finish, DataCenter_RtspClient2Command)
            rtsp_client_2_fifo_addr, rtsp_client_2_cur_num, rtsp_client_2_max_cur_num, rtsp_client_2_drop_num = collectDataCenter_Rtsp_client_2(
                DataCenter_Rtsp_client2)

            DataCenter_Rtsp_client3 = do_telnet(host, username, password, finish, DataCenter_RtspClient3Command)
            rtsp_client_3_fifo_addr, rtsp_client_3_cur_num, rtsp_client_3_max_cur_num, rtsp_client_3_drop_num = collectDataCenter_Rtsp_client_3(
                DataCenter_Rtsp_client3)

            DataCenter_Rtsp_client4 = do_telnet(host, username, password, finish, DataCenter_RtspClient4Command)
            rtsp_client_4_fifo_addr, rtsp_client_4_cur_num, rtsp_client_4_max_cur_num, rtsp_client_4_drop_num = collectDataCenter_Rtsp_client_4(
                DataCenter_Rtsp_client4)

            DataCenter_Rtsp_client5 = do_telnet(host, username, password, finish, DataCenter_RtspClient5Command)
            rtsp_client_5_fifo_addr, rtsp_client_5_cur_num, rtsp_client_5_max_cur_num, rtsp_client_5_drop_num = collectDataCenter_Rtsp_client_5(
                DataCenter_Rtsp_client5)

            DataCenter_Rtsp_client6 = do_telnet(host, username, password, finish, DataCenter_RtspClient6Command)
            rtsp_client_6_fifo_addr, rtsp_client_6_cur_num, rtsp_client_6_max_cur_num, rtsp_client_6_drop_num = collectDataCenter_Rtsp_client_6(
                DataCenter_Rtsp_client6)

            DataCenter_Rtsp_client7 = do_telnet(host, username, password, finish, DataCenter_RtspClient7Command)
            rtsp_client_7_fifo_addr, rtsp_client_7_cur_num, rtsp_client_7_max_cur_num, rtsp_client_7_drop_num = collectDataCenter_Rtsp_client_7(
                DataCenter_Rtsp_client7)

            DataCenter_Rtsp_client8 = do_telnet(host, username, password, finish, DataCenter_RtspClient8Command)
            rtsp_client_8_fifo_addr, rtsp_client_8_cur_num, rtsp_client_8_max_cur_num, rtsp_client_8_drop_num = collectDataCenter_Rtsp_client_8(
            ...
            rtsp_client_10_fifo_addr, rtsp_client_10_cur_num, rtsp_client_10_max_cur_num, rtsp_client_10_drop_num = collectDataCenter_Rtsp_client_10(
                DataCenter_Rtsp_client10)

            DataCenter_Rtsp_client11 = do_telnet(host, username, password, finish, DataCenter_RtspClient11Command)
            rtsp_client_11_fifo_addr, rtsp_client_11_cur_num, rtsp_client_11_max_cur_num, rtsp_client_11_drop_num = collectDataCenter_Rtsp_client_11(
                DataCenter_Rtsp_client11)

            DataCenter_Rtsp_client12 = do_telnet(host, username, password, finish, DataCenter_RtspClient12Command)
            rtsp_client_12_fifo_addr, rtsp_client_12_cur_num, rtsp_client_12_max_cur_num, rtsp_client_12_drop_num = collectDataCenter_Rtsp_client_12(
                DataCenter_Rtsp_client12)

            DataCenter_Rtsp_client13 = do_telnet(host, username, password, finish, DataCenter_RtspClient13Command)
            rtsp_client_13_fifo_addr, rtsp_client_13_cur_num, rtsp_client_13_max_cur_num, rtsp_client_13_drop_num = collectDataCenter_Rtsp_client_13(
                DataCenter_Rtsp_client13)

            DataCenter_Rtsp_client14 = do_telnet(host, username, password, finish, DataCenter_RtspClient14Command)
            rtsp_client_14_fifo_addr, rtsp_client_14_cur_num, rtsp_client_14_max_cur_num, rtsp_client_14_drop_num = collectDataCenter_Rtsp_client_14(
                DataCenter_Rtsp_client14)

            DataCenter_Rtsp_client15 = do_telnet(host, username, password, finish, DataCenter_RtspClient15Command)
            rtsp_client_15_fifo_addr, rtsp_client_15_cur_num, rtsp_client_15_max_cur_num, rtsp_client_15_drop_num = collectDataCenter_Rtsp_client_14(
                DataCenter_Rtsp_client15)

            DataCenter_Rtsp_server_setsei = do_telnet(host, username, password, finish,
            ...
            client.write_points(
                DataCenter_DataToInfluxDB(host, cur_num2, max_num2, max_cur_num2, pkg_mem_size2, cur_num3, max_num3,
                                          max_cur_num3, pkg_mem_size3))
            client.write_points(NNIE_DataToInfluxDB(host, CoreId0_CntPerSec, CoreId0_MaxCntPerSec, CoreId1_CntPerSec,
                                                    CoreId1_MaxCntPerSec))
            client.write_points(
                Rtsp_server_fifo_addr_DataToInfluxDB(host, rtsp_server_0_fifo_addr, rtsp_server_1_fifo_addr,
                                                     ...
                                                     rtsp_server_14_fifo_addr, rtsp_server_15_fifo_addr))
            client.write_points(Rtsp_server_cur_num_DataToInfluxDB(host, rtsp_server_0_cur_num, rtsp_server_1_cur_num,
            ...
            client.write_points(
                Rtsp_server_max_cur_num_DataToInfluxDB(host, rtsp_server_0_max_cur_num, rtsp_server_1_max_cur_num,
                                                       rtsp_server_2_max_cur_num, rtsp_server_3_max_cur_num,
            ...
            client.write_points(
                Rtsp_server_drop_num_DataToInfluxDB(host, rtsp_server_0_drop_num, rtsp_server_1_drop_num,
            ...
            client.write_points(
                Rtsp_client_fifo_addr_DataToInfluxDB(host, rtsp_client_0_fifo_addr, rtsp_client_1_fifo_addr,
            ...
            client.write_points(Rtsp_client_cur_num_DataToInfluxDB(host, rtsp_client_0_cur_num, rtsp_client_1_cur_num,
                                                                   ...
                                                                   rtsp_client_15_cur_num))
            client.write_points(
                Rtsp_client_max_cur_num_DataToInfluxDB(host, rtsp_client_0_max_cur_num, rtsp_client_1_max_cur_num,
            ...
            client.write_points(
                Rtsp_client_drop_num_DataToInfluxDB(host, rtsp_client_0_drop_num, rtsp_client_1_drop_num,
