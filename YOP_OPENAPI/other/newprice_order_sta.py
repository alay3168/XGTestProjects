...
#创建新一口价临时订单
    def createnewprice_post(self):
        ...
        payload = ({'city': 'bj',
                    ...
                    'time':self.post_time,
                    'sms_type':'0',
                    'access_token':'rT1z9DPL9Sem5cGRnzT8FwdNhSOldfHYzoAYUbHw', 
                    })
    ...
    def test_createpackage_new_airport(self):
        order_id = self.createnewprice_post()
        payload = ({'city': 'bj',
                    'type': '8',                   
                    'car_type_id':'1',
                    'start_position':u'中国技术交易大厦',
    ...
    def test_createpackage_new_allday(self):
...
if __name__ == '__main__':
    ...
    suite.addTest(CreateOrder_Test("test_createpackage_new_airport"))
    suite.addTest(CreateOrder_Test("test_createpackage_new_allday"))
