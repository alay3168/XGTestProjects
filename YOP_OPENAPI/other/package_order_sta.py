...
#创建本地一口价临时订单
    ...
    def test_createpackage_local_airport(self):
    ...
    def test_createpackage_local_allday(self):
...
if __name__ == '__main__':
    ...
    suite.addTest(CreateOrder_Test("test_createpackage_local_airport"))
    suite.addTest(CreateOrder_Test("test_createpackage_local_allday"))
