...
@ddt
class SearchCase(conf.FeiDanTest):
    @file_data(case_yml + "\search_face.yaml")
    def test_FaceSearch_case(self, **test_data):
        ...
        if method:
            ...
            if method == "GET":
                ...
                r = requests.post(url=base_url, data=data, headers=self.heads, verify=False)
            elif method == "PUT":
